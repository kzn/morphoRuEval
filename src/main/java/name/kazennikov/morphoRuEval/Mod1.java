...
public class Mod1 {
    ...
    public Mod1() throws Exception {
        lemmer = new Lemmer(new File("morphoRuEval/girkya_fixed.txt"), new File("morphoRuEval.dict.dat"));
...
//            feats.add("pos12/apos" + i + "=" + s.pos(wordIndex - 2) + s.pos(wordIndex - 1) + apos);
    ...
    public TIntArrayList possiblePOS(String wf) {
        ...
        for(Lemmer.Parse p: out) {
            ...
            set.add(labelAlphabet.get(p.pos));
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        if(trainModel) {
            ...
            mod1.writeModel(new File("morphoRuEval.mod1.dat"));
        }


        mod1.readModel(new File("morphoRuEval.mod1.dat"));

        mod1.eval("morphoRuEval.mod1.train", train);
        mod1.eval("morphoRuEval.mod1.test", test);
