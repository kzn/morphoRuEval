...
public class Mod3 {
    ...
    public void train(List<Sentence> train, int dim) throws Exception {
        ...
        ThreadPoolExecutor executor = ThreadPoolUtils.newBlockingThreadPoolExecutor(8, 8, 300, TimeUnit.SECONDS, 8);
    ...
    public List<String> feats(Sentence s, List<List<Lemmer.Parse>> parses, int wordIndex) {
        ...
        for(int i = -3; i < 0; i++) {
            ...
            for(String feat : s.feats(wordIndex + i).values()) {
                feats.add("feat" + i + feat);
            }
...
//                }
    ...
    public void evalNG(String prefix, List<Sentence> sents) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        mod3.evalNG("morphoRuEval.mod3.test", test);
        mod3.evalNG("morphoRuEval.mod3.train", train);
